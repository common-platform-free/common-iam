...
public class KeycloakErrorMapper {
     ...
     */
    public BusinessException toBusinessException(RestClientResponseException ex) {
        return switch (ex.getStatusCode().value()) {
            ...
            default -> new BusinessException(ErrorCode.INTERNAL_ERROR, "Keycloak 调用失败: " + ex.getStatusText());
        };
    }
}
